...
packer.startup(function()
    ...
    use({
        ...
        config = function()
            ...
            vim.keymap.set('n', '<Leader>/', builtin.live_grep, { desc = 'Grep files in current directory tree' })
            vim.keymap.set('n', '<Leader>b', builtin.buffers, { desc = 'Swap buffer' })
            vim.keymap.set('n', '<Leader>?', builtin.help_tags, { desc = 'Search Neovim help' })
            vim.keymap.set('n', '<Leader>r', builtin.lsp_references, { desc = 'Find references for object at point' })
            vim.keymap.set('n', '<Leader>s', builtin.lsp_document_symbols, { desc = 'List and select symbols' })
            vim.keymap.set('n', '<Leader>d', builtin.diagnostics, { desc = 'Open diagnostics list' })
        end,
    })
        ...
        config = function()
            ...
            local on_attach = function(_, bufnr)
                vim.keymap.set('n', '<Leader>k', vim.lsp.buf.hover,
                    { buffer = bufnr, desc = 'Show documentation for item at cursor' })
                ...
                vim.keymap.set('n', '<Leader>;', function() vim.lsp.buf.format({ async = true }) end,
                    { buffer = bufnr, desc = 'Reformat buffer' })
